...
Ключевые длительности (E_i):

- Поток «Проведение трансляций»: 1.1 Поиск 48.67; 1.2 Просмотр 633.33; 1.3 Запуск 273.33; 1.4 Сохранение 533.33
- «Настройка трансляции»: 4.1.1 Перед запуском 320.00; 4.2.1 Параметры для зрителя 286.67; 4.2.2 Перемотка 149.33
- «Регистрация/авторизация»: 5.1 Логин 110.67; 5.2 Смена пароля 48.67
- «Профиль»: 6.1 Имя 21.33; 6.2 Описание 21.33; 6.3 Фото 52.00
- «Подписки»: 2.1 Счётчик 60.00; 2.2 Отписка 24.67
- «Чат»: 3.1 Писать 24.33; 3.2 Отображение 20.83
- «Категории»: 7.1 Игры 97.33; 7.2 Жанры/действия 97.33
- «Клипы»: 8.1 Создать 200.00; 8.2 Поделиться 142.67
- «UI для всех функций» (доп. красивый): 733.33
- «Тестирование»: Альфа 150; Бета 250; Релиз 100 (≈500 суммарно)

Критические зависимости (сокращённо):
- 5.1 → 3.1, 2.1, 2.2, 6.1–6.3, 5.2
- 7.1 & 7.2 → 1.1
- 4.2.1 → 1.2
- 4.1.1 → 1.3 → 1.4 → 8.1 → 8.2
- «Готовность к тестированию» = max(готовность функциональности, UI), далее тестирование
